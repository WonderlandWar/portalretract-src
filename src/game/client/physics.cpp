...
#endif
{
	...
	// RETRACT:
	if ( !pEntity0->ShouldCollide( pEntity1->GetCollisionGroup(), pEntity1->PhysicsSolidMaskForEntity() ) )
		return 0;
	
	if ( !pEntity1->ShouldCollide( pEntity0->GetCollisionGroup(), pEntity0->PhysicsSolidMaskForEntity() ) )
		return 0;
